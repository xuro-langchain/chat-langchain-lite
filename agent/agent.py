...
def stream_agent(question: str, thread_id: str | None = None):
    """Stream the agent's final-message tokens as they're generated.

    Anthropic emits content as a list of typed blocks ({'type': 'text',
    'text': '...'}); other providers emit a single string. Handle both.
    """
